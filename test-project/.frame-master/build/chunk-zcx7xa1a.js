...
// cloudflare-client-bootstrap:/home/shpaw415/frame-master-plugins/cloudflare-worker-action/test-project/node_modules/frame-master-plugin-cloudflare-pages-functions-action/src/bootstrap.ts
	...
	switch (dataType) {
		...
		default:
			try {
				...
				throw new Error(
					`Unsupported data type returned from server action: ${response.headers.get("dataType")}`,
					{ cause: e },
				);
			}
	}
...
export { bootstrap_default };

//# debugId=DFA6F493A8D4117664756E2164756E21
//# sourceMappingURL=./chunk-zcx7xa1a.js.map
