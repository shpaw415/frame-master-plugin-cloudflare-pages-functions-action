...
var customRule = compositeTransformation(
	...
	(v, a, superJson) => {
		...
		if (!transformer) throw Error("Trying to deserialize unknown custom value");
...
function generateReferentialEqualityAnnotations(identitites, dedupe) {
	...
	else return isEmptyObject(result) ? undefined : result;
}
var walker = (
	object,
	identities,
...
async function WrapRequestHandler(context, endpoint) {
	...
	for (let i = 0; i < missingProps; i++) parsedData.push(undefined);
